    ...
    public static function for(string $slug): array
    {
        ...
        return [
            ...
            'stats' => [
                ...
                ['label' => 'Instructors', 'value' => (string) count($instructors), 'trend' => null, 'direction' => null, 'note' => $platform['region']],
                ['label' => 'Certificates issued', 'value' => (string) $certificates, 'trend' => $certificates > 0 ? '+'.min(3, $certificates) : null, 'direction' => $certificates > 0 ? 'up' : null, 'note' => 'this quarter'],
